...
#pragma mark - Ring progress animation（圈圈颜色）
...
- (SVIndefiniteAnimatedView *)indefiniteAnimatedView {
    if (_indefiniteAnimatedView == nil) {
        ...
        _indefiniteAnimatedView.strokeColor = homeHeaderColor;
...
- (UIView *)hudView {
    if(!_hudView) {
        ...
        _hudView.backgroundColor = [UIColor colorWithRed:0.0/225 green:0.0/225 blue:0.0/225 alpha:0.4];
