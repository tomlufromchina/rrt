...
- (void)setUp
{
    ...
    self.editable = YES;
    self.moreOptionsButtonTitle = @"更多";
...
- (CGFloat)menuOptionButtonWidth
{
    ...
    CGFloat width = roundf([string calculateSize:self.moreOptionsButton.titleLabel.font].width + 2. * self.menuOptionButtonTitlePadding);
