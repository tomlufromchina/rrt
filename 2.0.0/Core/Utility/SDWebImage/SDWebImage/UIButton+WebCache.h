...
@interface UIButton (WebCacheExpend)
- (void)setImageWithUrlStr:(NSString *)url forState:(UIControlState)state placholderImage:(UIImage *)placeholder;

- (void)setBgImageWithUrlStr:(NSString *)url forState:(UIControlState)state placholderImage:(UIImage *)placeholder;
@end
